Function New-PVUser {
	...
	param(
		...
		[Parameter(Mandatory = $True, ValueFromPipelineByPropertyName = $False)][string]$destUser,
		[Parameter(Mandatory = $False, ValueFromPipelineByPropertyName = $False)][string]$authType,
		...
		[Parameter(Mandatory = $True, ValueFromPipelineByPropertyName = $True)][string]$location,
		...
		[Parameter(Mandatory = $False, ValueFromPipelineByPropertyName = $False)][switch]$gatewayAccount,
