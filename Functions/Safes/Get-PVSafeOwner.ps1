Function Get-PVSafeOwner {
	...
	param(
		...
		[Parameter(Mandatory = $True, ValueFromPipelineByPropertyName = $False)][string]$ownerPattern,
		[Parameter(Mandatory = $False, ValueFromPipelineByPropertyName = $False)][switch]$includeGroupMembers,
